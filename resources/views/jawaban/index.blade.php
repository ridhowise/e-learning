...
<div class="blog-container">
    ...
    <div class="blog-cover">
      <div class="blog-author">
        ...
        <ol class="breadcrumb float-left float-md-right">
          <li class="breadcrumb-item"><a href="{{ url('quiz') }}">BACK <i class="fa fa-arrow-left"></i></a></li>
  ...
  <div class="blog-body">
    ...
    <div class="blog-summary">
      ...
      <h4>{{ $no++ }}. {{$items->soal->soal}}</h4>
      <textarea disabled class="form-control" type="text" name="jawab" >{{$items->jawab}}</textarea>
      <br>
      ...
      <form class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
        ...
        <hr>
        @if($nilai->nilai == "Belum dinilai")
      <div class="form-group row"><label class="col-lg-2 form-control-label">Nilai :</label>

        <div class="col-lg-4">
        <input type="text" name="nilai" placeholder="Belum dinilai" class="form-control" value="" required> 
        </div>
        </div>
      @else
      <div class="form-group row"><label class="col-lg-2 form-control-label">Nilai :</label>
        ...
        <div class="col-lg-4">
        <input type="text" name="nilai" placeholder="Belum dinilai" class="form-control" value="{{$nilai->nilai}}" required> 
        </div>
        </div>
        @endif
