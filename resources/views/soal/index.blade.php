...
<div class="blog-container">
  ...
  <div class="blog-body">
    ...
    <div class="blog-summary">
      ...
      @if($datas->status == 1)
      <div class="centerx">
        <a style="color:white" href="" class="btn btn-lg btn-info" >UJIAN SELESAI</a>
        </div>

       
             
              <div class="table-responsive">
                <table class="display table table-bordered" id="dataTablee" width="100%" cellspacing="0">
      ...
      <textarea required class="form-control" type="text" name="jawab[]" ></textarea>
      <br>
      ...
      <div class="form-group row">
        <div class="col-lg-offset-2 col-lg-10">
          <button type="submit" onclick="return confirm('Apakah anda yakin?');" class="btn btn-default" style="border:1px solid black;">Submit</button>
        </div>
    </div>
      </form>
      @endif
