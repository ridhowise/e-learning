...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Kelas <a href="{{ url('kelas/create') }}" class="btn btn-sm btn-primary" >Create</a>
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="{{ route('kelas.destroy', $items->id) }}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <!--<a href="{{ route('kelas.show',$items->id) }}">Lihat</a>
                    <a class="btn btn-sm btn-success" type="submit" href="{{ route('kelas.edit',$items->id) }}">Edit</a>-->
