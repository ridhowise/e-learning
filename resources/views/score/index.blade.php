    ...
    <div class="blog-cover">
      <div class="blog-author">
        ...
        <ol class="breadcrumb float-left float-md-right">
          <li class="breadcrumb-item"><a href="{{ url('exam') }}">BACK <i class="fa fa-arrow-left"></i></a></li>
  ...
  <div class="blog-body">
    ...
    <div class="blog-summary">
      ...
      <div class="form-group row"><label class="col-lg-2 form-control-label">Nilai :</label>
        ...
        <div class="col-lg-4">
        <input type="text" name="nilai" placeholder="Belum dinilai" class="form-control" value="{{$exam->nilai}}" required> 
        </div>
        </div>
        @endif
